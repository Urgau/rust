...
As of `2024-09-17T`, the list of known names is as follows:
...
[^test-cfg]: The `test` cfg is consider to be a "userspace" config despite being also set
by `rustc` and should be managed by the build-system.
